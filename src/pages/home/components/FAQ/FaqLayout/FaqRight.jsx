...
const FaqRight = () => {
  ...
  return (
    <div className='self-end'>
        <h4 className="font-poppins font-semibold text-2xl lg:text-[36px] text-black01">{t("Frequently_Asked_Questions")}</h4>
        ...
        <CommonButton className="!bg-orange !px-10 !h-12 !border-none !mt-5 !mb-5 lg:!mt-[60px] lg:!mb-0">
