  ...
  return (
    <div>
      <div className='flex items-center justify-between mb-3 lg:mb-12'>
            <h3 className='font-poppins text-lg md:text-[36px] font-semibold text-black01'>{t('best_seller')}</h3>
            <Link to="/product" className='flex items-center gap-x-2 font-montserrat font-bold text-sm lg:text-base text-orange group'>
                {t("view_all")}{" "}
