...
import {
  setGridView,
  setListView,
} from "../../../../services/redux/features/viewSlice";
      ...
      <div className="flex items-center justify-between mt-6">
        ...
        <div className="flex">
          ...
          <div className="flex items-center gap-x-2 justify-end mx-3">
            ...
            <div className="w-fit">
              <CustomDropdown
                className="font-montserrat font-bold text-sm lg:text-base text-orange cursor-pointer w-full flex justify-baseline items-center"
                icon={true}
                items={[
                  {
                    key: "1",
