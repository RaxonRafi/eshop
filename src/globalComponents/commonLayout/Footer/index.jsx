  ...
  return (
    <Container>
      <footer className="mt-20">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-x-2">
        ...
        <div className="mt-20 border-t border-t-black100 flex flex-col lg:flex-row justify-between items-center py-2">
              <span className="font-montserrat font-normal text-xs md:text-sm text-black200"> Copyright © {year} E-Shop. All Rights Reserved.</span>
              <div className="flex items-center gap-x-3">
                <Link className="font-montserrat font-normal text-black200 text-xs lg:text-sm">Privacy Policy</Link>
                <span className="text-black200">|</span>
                <Link className="font-montserrat font-normal text-black200 text-xs lg:text-sm">Terms & Condition</Link>
                <span className="text-black200">|</span>
                <Link className="font-montserrat font-normal text-black200 text-xs lg:text-sm">Sitemap</Link>
              </div>
        </div>
      </footer>
    </Container>
